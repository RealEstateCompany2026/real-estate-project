...
## Task
Create the 'Dashboard intégrations' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-07 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vue d'ensemble : santé des connexions, dernière sync, erreurs, volume de données
