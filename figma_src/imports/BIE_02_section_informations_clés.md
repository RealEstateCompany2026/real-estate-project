...
## Task
Create the 'Section Informations clés' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-02 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Type de bien (2 niveaux), type d’opération, adresse, surface, pièces, prix, propriétaire. Tous obligatoires.
