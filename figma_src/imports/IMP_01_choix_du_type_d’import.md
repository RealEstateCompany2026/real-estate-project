...
## Task
Create the 'Choix du type d’import' screen for the Import Base de Données parcours.

## Context
This is screen IMP-01 in parcours 5: Import Base de Données (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Sélection : Clients, Biens, Affaires. Option « Pas de fichier ».
