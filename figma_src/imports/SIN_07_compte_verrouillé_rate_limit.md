...
## Task
Create the 'Compte verrouillé (rate limit)' screen for the Sign-in parcours.

## Context
This is screen SIN-07 in parcours 2: Sign-in (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: « Trop de tentatives » + countdown 5 min + lien mot de passe oublié
