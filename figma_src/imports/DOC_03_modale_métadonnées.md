...
## Task
Create the 'Modale métadonnées' screen for the Documents parcours.

## Context
This is screen DOC-03 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Nom, catégorie, entité liée, dates. Affichée pour chaque fichier uploadé.
