...
## Task
Create the 'Page création client' screen for the Ajouter un client parcours.

## Context
This is screen CLI-01 in parcours 6: Ajouter un client (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Formulaire complet en sections repliables. Header avec titre « Nouveau client » et bouton retour.
