...
## Task
Create the 'Erreur de parsing' screen for the Import Base de Données parcours.

## Context
This is screen IMP-07 in parcours 5: Import Base de Données (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Message d’erreur + suggestion FAQ + bouton réessayer.
