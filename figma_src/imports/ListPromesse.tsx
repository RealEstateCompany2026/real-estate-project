import svgPaths from "./svg-bp677yf5td";
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0">
      <div className="bg-[#e6f6e5] content-stretch flex h-[20px] items-center px-[8px] py-[4px] relative rounded-[16px] shrink-0" data-name="atome . sticker">
        ...
        <p className="font-['roboto:Bold',sans-serif] leading-[14px] not-italic relative shrink-0 text-[#0da500] text-[12px] text-center tracking-[0.12px] whitespace-nowrap">REÇUE</p>
      </div>
      <div className="bg-[#e6f6e5] content-stretch flex h-[20px] items-center px-[8px] py-[4px] relative rounded-[16px] shrink-0" data-name="atome . sticker">
        <div aria-hidden="true" className="absolute border border-[#c3e9bf] border-solid inset-0 pointer-events-none rounded-[16px]" />
        <p className="font-['roboto:Bold',sans-serif] leading-[14px] not-italic relative shrink-0 text-[#0da500] text-[12px] text-center tracking-[0.12px] whitespace-nowrap">TRANSMISE</p>
      </div>
      <div className="bg-[#e6f6e5] content-stretch flex h-[20px] items-center px-[8px] py-[4px] relative rounded-[16px] shrink-0" data-name="atome . sticker">
        <div aria-hidden="true" className="absolute border border-[#c3e9bf] border-solid inset-0 pointer-events-none rounded-[16px]" />
        <p className="font-['roboto:Bold',sans-serif] leading-[14px] not-italic relative shrink-0 text-[#0da500] text-[12px] text-center tracking-[0.12px] whitespace-nowrap">ACCORD</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0">
      ...
      <div className="bg-white content-stretch flex gap-[8px] items-center justify-center p-[12px] relative rounded-[16px] shrink-0" data-name="button">
        ...
        <p className="font-['roboto:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">Voir la promesse</p>
...
export default function ListPromesse() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center px-[20px] py-[13px] relative rounded-[16px] size-full" data-name="List . promesse">
