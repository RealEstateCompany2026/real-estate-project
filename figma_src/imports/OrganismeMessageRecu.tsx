import svgPaths from "./svg-er2bvl2wty";
import { imgAttachFile, imgButton } from "./svg-rlp6e";
            ...
            <div className="absolute contents inset-0" data-name="vuesax/linear/arrow-circle-right">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox={isDark ? "0 0 24 24" : "0 0 20 20"}>
                <g id="arrow-circle-right">
                  ...
                  <path d={isDark ? svgPaths.p1129f1c0 : svgPaths.p149fcde0} id="Vector_2" stroke="var(--stroke-0, #444955)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            ...
            <div className="relative shrink-0" data-name="Body . md . light">
              <div className="flex flex-row items-center">
                <div className="content-stretch flex items-center px-[10px] py-[8px] relative">
                  <p className={`relative text-[#444955] text-[16px] tracking-[0.16px] ${isDark ? 'font-["roboto:Regular",sans-serif] leading-[20px] not-italic shrink-0 whitespace-nowrap' : 'font-["Roboto:Regular",sans-serif] font-normal leading-[22px]'}`} style={isLight ? { fontVariationSettings: "'wdth' 100" } : undefined}>
...
export default function OrganismeMessageRecu1() {
  return <OrganismeMessageRecu className="relative size-full" />;
}