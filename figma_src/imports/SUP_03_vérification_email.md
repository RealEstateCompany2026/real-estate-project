...
## Task
Create the 'Vérification email' screen for the Sign-up parcours.

## Context
This is screen SUP-03 in parcours 1: Sign-up (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: « Vérifiez votre boîte mail » + bouton Renvoyer + lien support
