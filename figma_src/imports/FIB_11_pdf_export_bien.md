...
## Task
Create the 'PDF export bien' screen for the Fiche bien parcours.

## Context
This is screen FIB-11 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Génération d’une fiche bien formatée (vitrine). Photos, description, caractéristiques, DPE, plan.
