...
## Task
Create the 'Vue calendrier' screen for the Événements parcours.

## Context
This is screen EVT-01 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Calendrier semaine/jour/mois. Code couleur par type. Drag & drop. Filtre agent et type.
