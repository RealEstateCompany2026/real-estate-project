...
## Task
Create the 'Page désabonnement' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-08 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Formulaire de gestion des préférences email (réduire fréquence ou se désabonner)
