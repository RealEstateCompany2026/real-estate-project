...
> Parcours 5: Import Base de Données | Vague 1 | Préfixe: IMP

## Task
Create the 'Prévisualisation' screen for the Import Base de Données parcours.

## Context
This is screen IMP-04 in parcours 5: Import Base de Données (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Résumé : lignes valides / avertissements / erreurs. Détail par ligne. Gestion doublons.
