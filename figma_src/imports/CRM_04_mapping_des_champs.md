...
## Task
Create the 'Mapping des champs' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-04 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Table de correspondance champ source → champ app, avec auto-détection
