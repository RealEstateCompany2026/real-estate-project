...
> Parcours 17: Campagne carnet d'entretien | Vague 3 | Préfixe: CAM

## Task
Create the 'Dashboard campagne' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-07 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Analytics détaillées : courbe envois/ouvertures/clics, liste destinataires avec statut
