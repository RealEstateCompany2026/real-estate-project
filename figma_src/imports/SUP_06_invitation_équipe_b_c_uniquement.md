...
## Task
Create the 'Invitation équipe (B/C uniquement)' screen for the Sign-up parcours.

## Context
This is screen SUP-06 in parcours 1: Sign-up (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Saisie emails d’équipiers + bouton Inviter + option Passer
