...
## Task
Create the 'Alerte expiration' screen for the Documents parcours.

## Context
This is screen DOC-08 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Banner dans la fiche bien si un diagnostic expire dans < 30 jours.
