...
## Task
Create the 'Générateur de descriptions' screen for the Automatisations IA parcours.

## Context
This is screen AIA-03 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: 3 variantes proposées. Sélection + édition. Historique des générations.
