...
## Task
Create the 'Badge scoring lead' screen for the Automatisations IA parcours.

## Context
This is screen AIA-04 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Badge Hot/Warm/Cold sur chaque lead dans la liste et la fiche.
