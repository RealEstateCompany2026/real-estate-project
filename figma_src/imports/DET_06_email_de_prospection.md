...
## Task
Create the 'Email de prospection' screen for the Détection mandat vente / gestion parcours.

## Context
This is screen DET-06 in parcours 16: Détection mandat vente / gestion (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Email pré-rédigé avec objet, corps HTML, lien estimation gratuite, CTA
