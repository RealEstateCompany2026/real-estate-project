...
## Task
Create the 'Modale partage' screen for the Fiche bien parcours.

## Context
This is screen FIB-10 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Génération de lien public. Choix de la durée d’expiration. Copie du lien + QR code.
