...
## Task
Create the 'Carte des comparables' screen for the Automatisations IA parcours.

## Context
This is screen AIA-07 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Mini-carte Leaflet avec markers des transactions DVF récentes.
