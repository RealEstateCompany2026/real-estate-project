...
## Task
Create the 'Section Fraîcheur' screen for the Audit Base de Données parcours.

## Context
This is screen AUD-04 in parcours 13: Audit Base de Données (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Distribution par date MAJ, fiches dormantes, statuts incohérents.
