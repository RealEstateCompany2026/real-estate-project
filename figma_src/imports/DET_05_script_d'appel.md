...
## Task
Create the 'Script d'appel' screen for the Détection mandat vente / gestion parcours.

## Context
This is screen DET-05 in parcours 16: Détection mandat vente / gestion (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Script généré par Claude API avec arguments personnalisés selon le signal
