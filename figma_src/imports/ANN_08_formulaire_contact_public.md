...
## Task
Create the 'Formulaire contact public' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-08 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Sur la page publique : nom, email, téléphone, message. Crée un lead dans l’app.
