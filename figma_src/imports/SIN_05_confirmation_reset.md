...
## Task
Create the 'Confirmation reset' screen for the Sign-in parcours.

## Context
This is screen SIN-05 in parcours 2: Sign-in (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: « Mot de passe mis à jour » + redirection auto sign-in (3s)
