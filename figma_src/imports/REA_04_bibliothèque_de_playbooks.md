...
## Task
Create the 'Bibliothèque de playbooks' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-04 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Catalogue des playbooks disponibles (préconfigurés + personnalisés), avec preview des étapes
