...
> Parcours 12: Documents | Vague 2 | Préfixe: DOC

## Task
Create the 'Modale génération modèle' screen for the Documents parcours.

## Context
This is screen DOC-07 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Sélection du contexte (client/bien/affaire). Preview du document rempli. Téléchargement.
