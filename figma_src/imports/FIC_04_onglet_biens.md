...
## Task
Create the 'Onglet Biens' screen for the Fiche client parcours.

## Context
This is screen FIC-04 in parcours 8: Fiche client (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des biens du client (propriétaire). Cards avec photo, adresse, prix, statut. Bouton « + Ajouter un bien ».
