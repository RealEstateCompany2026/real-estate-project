...
## Task
Create the 'Modale édition' screen for the Événements parcours.

## Context
This is screen EVT-06 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Même formulaire que la création, pré-rempli. + bouton Supprimer.
