import svgPaths from "./svg-y38uo3q34n";
import { imgDoorFront, imgAtomeIconTextMedium } from "./svg-al990";
type AppBarFicheAffaireMetricsHelper1Props = {
  additionalClassNames?: string;
};

function AppBarFicheAffaireMetricsHelper1({ children, additionalClassNames = "" }: React.PropsWithChildren<AppBarFicheAffaireMetricsHelper1Props>) {
  return (
...
type AppBarFicheAffaireMetricsHelperProps = {
  additionalClassNames?: string;
};

function AppBarFicheAffaireMetricsHelper({ children, additionalClassNames = "" }: React.PropsWithChildren<AppBarFicheAffaireMetricsHelperProps>) {
  return (
    <div className={additionalClassNames}>
...
function AppBarFicheAffaireMetricsVuesaxLinearHeart({ children }: React.PropsWithChildren<{}>) {
  return (
...
function AppBarFicheAffaireMetricsVuesaxLinearDirectInbox({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 size-[20px]">
...
function AppBarFicheAffaireMetricsVuesaxLinearGallery({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 size-[20px]">
...
function AppBarFicheAffaireMetricsVuesaxLinearMessageNotif({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 size-[20px]">
...
type AppBarFicheAffaireMetricsAtomeIconTextMediumText1Props = {
  text: string;
};

function AppBarFicheAffaireMetricsAtomeIconTextMediumText1({ text }: AppBarFicheAffaireMetricsAtomeIconTextMediumText1Props) {
  return (
    <Wrapper>
...
type AppBarFicheAffaireMetricsAtomeIconTextMediumTextProps = {
  text: string;
};

function AppBarFicheAffaireMetricsAtomeIconTextMediumText({ text }: AppBarFicheAffaireMetricsAtomeIconTextMediumTextProps) {
  return (
    <Wrapper>
      <VuesaxLinearDocumentText>
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
          <g id="document-text">
            ...
            <path d="M19.5 0.5V19.5H0.5V0.5H19.5Z" id="Vector_5" opacity="0" stroke="var(--stroke-0, #444955)" />
          </g>
        </svg>
      </VuesaxLinearDocumentText>
      <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
...
type AppBarFicheAffaireMetricsProps = {
  className?: string;
  propriete1?: "light" | "dark";
};

function AppBarFicheAffaireMetrics({ className, propriete1 = "light" }: AppBarFicheAffaireMetricsProps) {
  const isDark = propriete1 === "dark";
  return (
    <div className={className || `h-[100px] relative w-[1191px] ${isDark ? "bg-[#111215]" : "bg-white"}`}>
      <div className="content-stretch flex flex-col items-start pb-[41px] pl-[20px] pr-[157px] pt-[39px] relative size-full">
        {propriete1 === "light" && (
          <div className="content-stretch flex gap-[40px] items-center relative shrink-0" data-name="bar metrics light">
            <Wrapper>
              <AppBarFicheAffaireMetricsVuesaxLinearMessageNotif>
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                  <g id="message-notif">
            ...
            <AppBarFicheAffaireMetricsAtomeIconTextMediumText text="signé" />
            <Wrapper>
              <AppBarFicheAffaireMetricsVuesaxLinearGallery>
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                  <g id="gallery">
              ...
              <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
                <p className="leading-[20px]">publié</p>
              </div>
            </Wrapper>
            <Wrapper>
              <AppBarFicheAffaireMetricsVuesaxLinearDirectInbox>
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                  <g id="direct-inbox">
              ...
              <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
                <p className="leading-[20px]">8 demandes</p>
              </div>
            </Wrapper>
            <Wrapper>
              ...
              <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
                <p className="leading-[20px]">4 visites</p>
              </div>
            </Wrapper>
            <Wrapper>
              <AppBarFicheAffaireMetricsVuesaxLinearHeart>
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                  <g id="heart">
              ...
              <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
                <p className="leading-[20px]">1 promesse</p>
              </div>
            </Wrapper>
            <AppBarFicheAffaireMetricsAtomeIconTextMediumText text="signé" />
            <Wrapper>
              <AppBarFicheAffaireMetricsHelper additionalClassNames="relative shrink-0 size-[20px]">
              ...
              </AppBarFicheAffaireMetricsHelper>
              <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
                <p className="leading-[20px]">en cours</p>
              </div>
            </Wrapper>
            <Wrapper>
              <div className="relative shrink-0 size-[20px]" data-name="vuesax/linear/judge">
                <AppBarFicheAffaireMetricsHelper additionalClassNames="absolute contents inset-0">
                  <g id="judge">
              ...
              <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
                <p className="leading-[20px]">fixé</p>
              </div>
            </Wrapper>
          </div>
        )}
        {isDark && (
          <div className="content-stretch flex gap-[40px] items-center relative shrink-0" data-name="bar metrics dark">
            <Wrapper>
              <AppBarFicheAffaireMetricsVuesaxLinearMessageNotif>
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                  <g id="message-notif">
            ...
            <AppBarFicheAffaireMetricsAtomeIconTextMediumText1 text="Texte" />
            <Wrapper>
              <AppBarFicheAffaireMetricsVuesaxLinearGallery>
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                  <g id="gallery">
            ...
            <Wrapper>
              <div className="relative shrink-0 size-[20px]" data-name="icn_door_front">
                <div className="absolute inset-[12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3px_-3px] mask-size-[24px_24px]" data-name="door_front" style={{ maskImage: `url('${imgAtomeIconTextMedium}')` }}>
            ...
            <AppBarFicheAffaireMetricsAtomeIconTextMediumText1 text="Texte" />
            <Wrapper>
              <AppBarFicheAffaireMetricsHelper1 additionalClassNames="relative shrink-0 size-[20px]">
                <g id="vuesax/linear/money-recive">
                  <g id="Group">
              ...
              </AppBarFicheAffaireMetricsHelper1>
              <div className="flex flex-col font-['roboto:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#444955] text-[16px] tracking-[0.16px] whitespace-nowrap">
                <p className="leading-[20px]">Texte</p>
              </div>
            </Wrapper>
            <Wrapper>
              <div className="relative shrink-0 size-[20px]" data-name="vuesax/linear/judge">
                <AppBarFicheAffaireMetricsHelper1 additionalClassNames="absolute contents inset-0">
                  <g id="judge">
...
export default function AppBarFicheAffaireMetrics1() {
  return <AppBarFicheAffaireMetrics className="bg-white relative size-full" />;
}