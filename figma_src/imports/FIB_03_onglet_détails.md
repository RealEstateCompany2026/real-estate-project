...
## Task
Create the 'Onglet Détails' screen for the Fiche bien parcours.

## Context
This is screen FIB-03 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Description, caractéristiques, DPE visuel, chauffage, annexes, charges, mandat, notes, tags. Édition inline.
