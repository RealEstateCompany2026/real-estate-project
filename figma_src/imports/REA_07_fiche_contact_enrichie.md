...
## Task
Create the 'Fiche contact enrichie' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-07 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Ajout sur la fiche client (P8) : badge segment, timeline engagement, signaux collectés, playbook actif
