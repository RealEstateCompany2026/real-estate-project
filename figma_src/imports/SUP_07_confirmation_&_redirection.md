...
## Task
Create the 'Confirmation & redirection' screen for the Sign-up parcours.

## Context
This is screen SUP-07 in parcours 1: Sign-up (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Message de succès + redirection auto vers Onboarding Product Tour
