...
## Task
Create the 'Preview annonce' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-03 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Simulation du rendu final : carousel, caractéristiques, DPE, description, carte.
