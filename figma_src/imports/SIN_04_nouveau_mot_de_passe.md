...
## Task
Create the 'Nouveau mot de passe' screen for the Sign-in parcours.

## Context
This is screen SIN-04 in parcours 2: Sign-in (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Nouveau mdp + confirmation + indicateur de force + bouton valider
