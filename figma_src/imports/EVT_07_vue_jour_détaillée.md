...
## Task
Create the 'Vue jour détaillée' screen for the Événements parcours.

## Context
This is screen EVT-07 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Planning heure par heure. Affichage dense avec blocs colorés.
