...
## Task
Create the 'Prévisualisation' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-06 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Rendu email desktop + mobile avec données réelles d'un propriétaire exemple
