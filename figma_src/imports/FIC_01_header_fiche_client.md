...
## Task
Create the 'Header fiche client' screen for the Fiche client parcours.

## Context
This is screen FIC-01 in parcours 8: Fiche client (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Nom, prénom, badge type, avatar (initiales), agent référent, jauge de complétude, barre d’actions rapides.
