...
## Task
Create the 'Onglet Événements' screen for the Affaires parcours.

## Context
This is screen AFF-07 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Timeline des interactions. Même composant FIC-06.
