...
## Task
Create the 'Suivi playbook actif' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-06 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vue d'un playbook en cours : contacts engagés, étape courante de chaque contact, taux de progression
