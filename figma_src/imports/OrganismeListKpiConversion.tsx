import svgPaths from "./svg-d6z7pgkner";

export default function OrganismeListKpiConversion() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative size-full" data-name="organisme . list . kpi . conversion">
