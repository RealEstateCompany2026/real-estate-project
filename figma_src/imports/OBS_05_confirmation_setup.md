...
## Task
Create the 'Confirmation Setup' screen for the Onboarding — Setup parcours.

## Context
This is screen OBS-05 in parcours 4: Onboarding — Setup (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Message de succès + résumé de la complétion + CTA vers dashboard ou import BDD.
