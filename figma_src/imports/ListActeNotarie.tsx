import svgPaths from "./svg-0amstthlpi";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0">
      <div className="bg-[#fff0e5] content-stretch flex h-[20px] items-center px-[8px] py-[4px] relative rounded-[16px] shrink-0" data-name="atome . sticker">
        <div aria-hidden="true" className="absolute border border-[#ffdabf] border-solid inset-0 pointer-events-none rounded-[16px]" />
        <p className="font-['roboto:Bold',sans-serif] leading-[14px] not-italic relative shrink-0 text-[#ff6b00] text-[12px] text-center tracking-[0.12px] whitespace-nowrap">PROGAMMÉ</p>
      </div>
...
export default function ListActeNotarie() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center px-[20px] py-[13px] relative rounded-[16px] size-full" data-name="List . acte notarié">
