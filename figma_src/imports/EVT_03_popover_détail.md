...
> Parcours 11: Événements | Vague 2 | Préfixe: EVT

## Task
Create the 'Popover détail' screen for the Événements parcours.

## Context
This is screen EVT-03 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Détail d’un événement au clic. Titre, type, heure, participants. Actions : éditer, supprimer, fait.
