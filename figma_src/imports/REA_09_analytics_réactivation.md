...
## Task
Create the 'Analytics réactivation' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-09 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: KPIs détaillés : taux par segment, coût réactivation vs acquisition, ROI, prédictions
