...
## Task
Create the 'Modale transition' screen for the Affaires parcours.

## Context
This is screen AFF-10 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Formulaire contextuel lors d’un changement d’étape (ex : saisie montant offre).
