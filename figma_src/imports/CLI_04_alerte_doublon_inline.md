...
## Task
Create the 'Alerte doublon inline' screen for the Ajouter un client parcours.

## Context
This is screen CLI-04 in parcours 6: Ajouter un client (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Banner contextuel sous le champ déclencheur. Affiche nom + type + agent référent du doublon potentiel. Actions : « Voir la fiche » / « Créer quand même ».
