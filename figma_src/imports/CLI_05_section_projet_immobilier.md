...
## Task
Create the 'Section Projet immobilier' screen for the Ajouter un client parcours.

## Context
This is screen CLI-05 in parcours 6: Ajouter un client (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Nature du projet, Budget (fourchette min/max), Secteur géographique (communes, auto-complétion), Critères (surface, nb pièces, etc.).
