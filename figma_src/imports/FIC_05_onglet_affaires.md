...
## Task
Create the 'Onglet Affaires' screen for the Fiche client parcours.

## Context
This is screen FIC-05 in parcours 8: Fiche client (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des affaires liées. Cards avec type, statut pipeline, montant, dates. Bouton « + Nouvelle affaire ».
