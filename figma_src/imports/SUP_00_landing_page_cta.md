...
## Task
Create the 'Landing page (CTA)' screen for the Sign-up parcours.

## Context
This is screen SUP-00 in parcours 1: Sign-up (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Page marketing avec bouton « Essai gratuit 14 jours »
