...
## Task
Create the 'Modale publication' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-05 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Confirmation + choix des canaux. Bouton Publier.
