...
> Parcours 2: Sign-in | Vague 1 | Préfixe: SIN

## Task
Create the 'Mot de passe oublié : confirmation envoi' screen for the Sign-in parcours.

## Context
This is screen SIN-03 in parcours 2: Sign-in (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: « Vérifiez votre boîte mail » + bouton Renvoyer (cooldown 60s) + détection fournisseur
