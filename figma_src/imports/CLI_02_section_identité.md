...
## Task
Create the 'Section Identité' screen for the Ajouter un client parcours.

## Context
This is screen CLI-02 in parcours 6: Ajouter un client (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Type de client (select : Propriétaire, Acquéreur, Locataire, Vendeur, Autre), Civilité (M./Mme), Nom, Prénom. Tous obligatoires.
