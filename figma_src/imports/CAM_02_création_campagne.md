...
## Task
Create the 'Création campagne' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-02 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Wizard en 4 étapes : Audience → Contenu → Template → Planification
