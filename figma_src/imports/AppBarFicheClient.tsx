import svgPaths from "./svg-j58c7dvm5p";
import { imgCalendarCheck, imgIcnCalendarCheck } from "./svg-pqmv0";
...
function AppBarFicheClientIconButton({ children }: React.PropsWithChildren<{}>) {
  return (
...
type AppBarFicheClientAtomeStickerText1Props = {
  text: string;
};

function AppBarFicheClientAtomeStickerText1({ text }: AppBarFicheClientAtomeStickerText1Props) {
  return (
    <div className="h-[20px] relative rounded-[16px] shrink-0">
      ...
      <Wrapper1>
        <p className="font-['roboto:Bold',sans-serif] leading-[14px] not-italic relative shrink-0 text-[#dadbdd] text-[12px] text-center tracking-[0.12px] whitespace-nowrap">{text}</p>
      </Wrapper1>
    </div>
  );
}
type AppBarFicheClientAtomeStickerTextProps = {
  text: string;
};

function AppBarFicheClientAtomeStickerText({ text }: AppBarFicheClientAtomeStickerTextProps) {
  return (
    <div className="h-[20px] relative rounded-[16px] shrink-0">
...
type AppBarFicheClientH4DesktopLightTextProps = {
  text: string;
};

function AppBarFicheClientH4DesktopLightText({ text }: AppBarFicheClientH4DesktopLightTextProps) {
  return (
    <div className="relative shrink-0">
      <div className="flex flex-row items-center size-full">
...
type AppBarFicheClientProps = {
  className?: string;
  propriete1?: "light" | "dark";
};

function AppBarFicheClient({ className, propriete1 = "light" }: AppBarFicheClientProps) {
        ...
        <div className="content-stretch flex flex-col items-start justify-center py-[27px] relative size-full">
          {propriete1 === "light" && (
            <div className="content-stretch flex gap-[24px] items-center relative shrink-0" data-name="bar fiche client light">
              ...
              <AppBarFicheClientH4DesktopLightText text="NOM, prénom du client" />
              <AppBarFicheClientAtomeStickerText text="VENDEUR" />
              <AppBarFicheClientAtomeStickerText text="ACQUÉREUR" />
          ...
          {isDark && (
            <div className="content-stretch flex gap-[24px] items-center relative shrink-0" data-name="bar fiche client dark">
              ...
              <AppBarFicheClientH4DesktopLightText text="H4 . Bold . Desktop" />
              <AppBarFicheClientAtomeStickerText1 text="LABEL" />
              <AppBarFicheClientAtomeStickerText1 text="LABEL" />
...
export default function AppBarFicheClient1() {
  return <AppBarFicheClient className="bg-white relative size-full" />;
}