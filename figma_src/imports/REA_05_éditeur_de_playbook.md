...
## Task
Create the 'Éditeur de playbook' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-05 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Création / modification d'un playbook : drag & drop des étapes, délais, conditions, contenu
