...
## Task
Create the 'Résolution de conflits' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-10 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Comparaison côte à côte des versions en conflit, choix de la version à garder
