...
> Parcours 3: Onboarding — Product Tour | Vague 1 | Préfixe: OBT

## Task
Create the 'Modale bienvenue' screen for the Onboarding — Product Tour parcours.

## Context
This is screen OBT-00 in parcours 3: Onboarding — Product Tour (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Message de bienvenue personnalisé + CTA « C’est parti » + lien « Passer »
