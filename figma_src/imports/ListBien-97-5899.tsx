import svgPaths from "./svg-0fzi3cwht9";
import imgListBien from "figma:asset/ea149919048c49c233547426cab6a80f99a70e99.png";
import { imgListBien1 } from "./svg-z1dh4";

export default function ListBien() {
  return (
    <div className="bg-[#ecedee] content-stretch flex flex-col items-start relative rounded-[16px] size-full" data-name="list . bien">
      ...
      <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
        ...
        <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-[77px]" data-name="organisme . list . kpi . qualification">
          ...
          <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
            ...
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[45px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[54px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[63px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[72px] mt-0 rounded-[8px] row-1 w-[6px]" />
          </div>
        </div>
        <div className="h-[84px] relative shrink-0 w-0" data-name="vertical divider . 84px">
          <div className="absolute flex inset-0 items-center justify-center">
        ...
        <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-[78px]" data-name="organisme . list . kpi . entretien">
          ...
          <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
            ...
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[27px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[36px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[45px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[54px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[63px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[72px] mt-0 rounded-[8px] row-1 w-[6px]" />
        ...
        <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-[78px]" data-name="organisme . list . kpi . conversion">
          ...
          <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
            ...
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[18px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[27px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[36px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[45px] mt-0 rounded-[8px] row-1 w-[6px]" />
            <div className="bg-[#dadbdd] col-1 h-[14px] ml-[54px] mt-0 rounded-[8px] row-1 w-[6px]" />
