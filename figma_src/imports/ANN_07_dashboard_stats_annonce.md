...
## Task
Create the 'Dashboard stats annonce' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-07 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vues, contacts, conversion, graphique courbe. Dans l’onglet Annonce de la fiche bien.
