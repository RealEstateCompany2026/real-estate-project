import svgPaths from "./svg-vm8u6w1u4r";
import { imgArrowDropUp, imgArrowDropDown } from "./svg-av2my";
...
export default function OrganismeScoringSectionList1() {
  return <OrganismeScoringSectionList className="relative size-full" propriete1="Down light" />;
}