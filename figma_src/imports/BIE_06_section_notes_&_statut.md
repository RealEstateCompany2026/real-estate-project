...
## Task
Create the 'Section Notes & statut' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-06 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Statut du bien, référence interne, mandat, note interne, tags.
