...
## Task
Create the 'Checklist pré-publication' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-02 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vérification des champs requis. Items vert/rouge. Liens « Compléter ».
