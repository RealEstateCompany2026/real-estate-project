...
## Task
Create the 'Sélecteur DPE visuel' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-09 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Composant custom affichant les classes AàG en vignettes colorées. Clic pour sélectionner.
