...
## Task
Create the 'Onglet Événements' screen for the Fiche bien parcours.

## Context
This is screen FIB-06 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Timeline chronologique des interactions liées au bien. Même composant FIC-06.
