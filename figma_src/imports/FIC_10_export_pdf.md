...
## Task
Create the 'Export PDF' screen for the Fiche client parcours.

## Context
This is screen FIC-10 in parcours 8: Fiche client (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Génération d’un PDF récapitulatif de la fiche client (identité, projet, historique récent). Téléchargement direct.
