...
## Task
Create the 'Notification push' screen for the Événements parcours.

## Context
This is screen EVT-09 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Notification navigateur (Web Push API). Titre + détail court.
