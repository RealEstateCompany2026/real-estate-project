...
## Task
Create the 'Onglet Matching (fiche bien)' screen for the Automatisations IA parcours.

## Context
This is screen AIA-01 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des clients acquéreurs potentiels classés par score. Actions : appeler, email, visite.
