...
## Task
Create the 'Configuration modules' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-04 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Toggle ON/OFF pour chaque module de contenu + paramètres spécifiques
