...
## Task
Create the 'Carte thermique' screen for the Détection mandat vente / gestion parcours.

## Context
This is screen DET-02 in parcours 16: Détection mandat vente / gestion (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Carte Leaflet avec heatmap des zones à forte opportunité de mandats
