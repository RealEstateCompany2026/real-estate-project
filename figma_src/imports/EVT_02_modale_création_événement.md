...
## Task
Create the 'Modale création événement' screen for the Événements parcours.

## Context
This is screen EVT-02 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Formulaire : type, titre, date/heure, clients, bien, affaire, lieu, rappel, note.
