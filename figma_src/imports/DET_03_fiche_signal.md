...
## Task
Create the 'Fiche signal' screen for the Détection mandat vente / gestion parcours.

## Context
This is screen DET-03 in parcours 16: Détection mandat vente / gestion (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Détail d'un signal : propriétaire, bien, contexte, historique, comparables marché, score
