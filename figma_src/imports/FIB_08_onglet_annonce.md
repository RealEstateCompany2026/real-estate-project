...
## Task
Create the 'Onglet Annonce' screen for the Fiche bien parcours.

## Context
This is screen FIB-08 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Preview de l’annonce. Statut de diffusion (non publié, actif, en pause). Bouton publier.
