...
## Task
Create the 'Section Description' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-03 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Titre annonce (auto-généré), description longue, étage, année construction, état général.
