...
## Task
Create the 'Résultat & actions' screen for the Import Base de Données parcours.

## Context
This is screen IMP-06 in parcours 5: Import Base de Données (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Récapitulatif chiffré + CTA (voir, reimporter, corriger, dashboard).
