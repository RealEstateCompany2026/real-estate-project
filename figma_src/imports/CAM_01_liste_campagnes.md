...
## Task
Create the 'Liste campagnes' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-01 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vue liste de toutes les campagnes (actives, planifiées, terminées) avec stats rapides
