...
## Task
Create the 'Zone d’upload' screen for the Documents parcours.

## Context
This is screen DOC-02 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Drag & drop + clic. Multi-fichiers. Barre de progression.
