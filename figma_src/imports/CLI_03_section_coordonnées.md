...
## Task
Create the 'Section Coordonnées' screen for the Ajouter un client parcours.

## Context
This is screen CLI-03 in parcours 6: Ajouter un client (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Téléphone (format international auto-détecté), Email (validation format), Adresse (auto-complétion via API adresse.data.gouv.fr). Au moins 1 contact requis.
