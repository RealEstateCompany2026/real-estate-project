...
## Task
Create the 'Éditeur de template' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-05 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Personnalisation visuelle : logo, couleurs, photo, signature, mentions légales
