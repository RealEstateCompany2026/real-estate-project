...
## Task
Create the 'Prévisualisation' screen for the Documents parcours.

## Context
This is screen DOC-04 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Viewer PDF inline (iframe). Lightbox pour images. Téléchargement pour les autres formats.
