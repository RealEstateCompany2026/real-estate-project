...
## Task
Create the 'Lien expiré / invalide' screen for the Sign-in parcours.

## Context
This is screen SIN-06 in parcours 2: Sign-in (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Message d’erreur + bouton « Renvoyer un lien »
