...
> Parcours 10: Affaires | Vague 2 | Préfixe: AFF

## Task
Create the 'Card affaire (kanban)' screen for the Affaires parcours.

## Context
This is screen AFF-12 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Composant card dans le kanban : badge type, adresse bien, client, montant, avatar agent.
