...
## Task
Create the 'Settings IA' screen for the Automatisations IA parcours.

## Context
This is screen AIA-09 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Page settings admin : activation/désactivation de chaque module. Quotas API.
