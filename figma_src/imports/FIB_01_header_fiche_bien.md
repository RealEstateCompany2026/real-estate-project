...
## Task
Create the 'Header fiche bien' screen for the Fiche bien parcours.

## Context
This is screen FIB-01 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Titre, badge statut, référence, ligne métriques clés, jauge complétude, barre actions.
