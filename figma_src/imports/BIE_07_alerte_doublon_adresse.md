...
## Task
Create the 'Alerte doublon adresse' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-07 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Banner contextuel sous le champ adresse. Affiche adresse + type + statut du doublon. Actions : Voir la fiche / Créer quand même.
