...
> Parcours 15: Automatisations IA | Vague 3 | Préfixe: AIA

## Task
Create the 'Biens correspondants (fiche client)' screen for the Automatisations IA parcours.

## Context
This is screen AIA-02 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des biens matchant les critères du client. Actions : partager, planifier visite.
