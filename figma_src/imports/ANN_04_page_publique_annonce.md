...
## Task
Create the 'Page publique annonce' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-04 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Page accessible sans auth. Photos, description, DPE, caractéristiques, formulaire contact.
