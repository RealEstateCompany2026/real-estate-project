...
## Task
Create the 'Section Estimation (fiche bien)' screen for the Automatisations IA parcours.

## Context
This is screen AIA-06 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Fourchette de prix, prix/m², nb comparables, carte. Bouton générer rapport.
