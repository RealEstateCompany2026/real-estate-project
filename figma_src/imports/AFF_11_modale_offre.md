...
## Task
Create the 'Modale offre' screen for the Affaires parcours.

## Context
This is screen AFF-11 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Création/édition d’une offre : montant, client, date validité, commentaire.
