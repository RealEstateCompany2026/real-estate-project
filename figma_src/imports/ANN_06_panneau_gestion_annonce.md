...
## Task
Create the 'Panneau gestion annonce' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-06 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Statut, date publication, lien, actions (pause, retrait, modification).
