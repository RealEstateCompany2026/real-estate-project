...
> Parcours 14: Annonce immobilière | Vague 2 | Préfixe: ANN

## Task
Create the 'Éditeur d’annonce' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-01 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Formulaire pré-rempli : titre, description, sélection photos, mentions. Split view avec preview.
