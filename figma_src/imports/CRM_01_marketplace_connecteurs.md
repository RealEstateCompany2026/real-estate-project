...
## Task
Create the 'Marketplace connecteurs' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-01 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Grille de tous les connecteurs disponibles avec statut, icône, catégorie
