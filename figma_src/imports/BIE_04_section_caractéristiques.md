...
## Task
Create the 'Section Caractéristiques' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-04 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Surface terrain, chambres, SDB, chauffage, exposition, annexes (checkboxes), DPE, charges, taxe foncière.
