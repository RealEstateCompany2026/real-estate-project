...
## Task
Create the 'Checklist obligatoires' screen for the Documents parcours.

## Context
This is screen DOC-05 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des documents requis par type d’opération. Statut présent/manquant/expiré.
