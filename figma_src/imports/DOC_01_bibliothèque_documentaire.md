...
## Task
Create the 'Bibliothèque documentaire' screen for the Documents parcours.

## Context
This is screen DOC-01 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vue liste/grille. Filtres, recherche, upload. Toutes les catégories.
