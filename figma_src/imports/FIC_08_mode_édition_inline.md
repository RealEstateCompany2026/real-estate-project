...
## Task
Create the 'Mode édition inline' screen for the Fiche client parcours.

## Context
This is screen FIC-08 in parcours 8: Fiche client (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Transformation des champs texte en inputs. Auto-save + indicateur. Bouton « Annuler » pour revenir au mode lecture.
