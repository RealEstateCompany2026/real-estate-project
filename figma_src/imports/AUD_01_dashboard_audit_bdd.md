...
## Task
Create the 'Dashboard Audit BDD' screen for the Audit Base de Données parcours.

## Context
This is screen AUD-01 in parcours 13: Audit Base de Données (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Score global, 4 dimensions, graphique évolution, top 5 recommandations.
