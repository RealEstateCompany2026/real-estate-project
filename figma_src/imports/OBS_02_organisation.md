...
## Task
Create the 'Organisation' screen for the Onboarding — Setup parcours.

## Context
This is screen OBS-02 in parcours 4: Onboarding — Setup (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Identité agence, infos légales (SIRET, carte T/G), logo. Champs réseau pré-remplis si C.
