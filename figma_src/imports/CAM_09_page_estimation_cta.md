...
## Task
Create the 'Page estimation CTA' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-09 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Landing page personnalisée avec estimation du bien + formulaire de contact
