import svgPaths from "./svg-3m7tsxgzyt";
  ...
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0">
      <div className="bg-[#e6f6e5] content-stretch flex h-[20px] items-center px-[8px] py-[4px] relative rounded-[16px] shrink-0" data-name="atome . sticker">
        ...
        <p className="font-['roboto:Bold',sans-serif] leading-[14px] not-italic relative shrink-0 text-[#0da500] text-[12px] text-center tracking-[0.12px] whitespace-nowrap">ACTIVÉ</p>
      </div>
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="atome . icon + text . medium">
...
export default function ListCarnet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start pl-[33px] pr-[37px] py-[25px] relative rounded-[16px] size-full" data-name="list . carnet">
