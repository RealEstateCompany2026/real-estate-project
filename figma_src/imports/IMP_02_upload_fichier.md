...
## Task
Create the 'Upload fichier' screen for the Import Base de Données parcours.

## Context
This is screen IMP-02 in parcours 5: Import Base de Données (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Zone drag & drop, formats acceptés, barre de progression, aperçu 5 lignes.
