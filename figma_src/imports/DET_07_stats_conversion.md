...
## Task
Create the 'Stats conversion' screen for the Détection mandat vente / gestion parcours.

## Context
This is screen DET-07 in parcours 16: Détection mandat vente / gestion (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: KPIs de prospection : taux de contact, taux de conversion, mandats signés, CA prévisionnel
