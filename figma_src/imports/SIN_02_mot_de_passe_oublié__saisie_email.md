...
## Task
Create the 'Mot de passe oublié : saisie email' screen for the Sign-in parcours.

## Context
This is screen SIN-02 in parcours 2: Sign-in (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Champ email + bouton « Envoyer le lien » + lien retour sign-in
