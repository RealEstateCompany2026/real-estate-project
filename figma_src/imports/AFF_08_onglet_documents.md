...
## Task
Create the 'Onglet Documents' screen for the Affaires parcours.

## Context
This is screen AFF-08 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Documents liés à l’affaire. Upload.
