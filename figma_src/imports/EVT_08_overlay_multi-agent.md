...
## Task
Create the 'Overlay multi-agent' screen for the Événements parcours.

## Context
This is screen EVT-08 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Superposition des calendriers de plusieurs agents. Couleurs différentes par agent.
