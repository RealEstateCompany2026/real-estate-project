...
## Task
Create the 'Fiche connecteur' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-02 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Détail du connecteur : description, pré-requis, bouton connexion, configuration
