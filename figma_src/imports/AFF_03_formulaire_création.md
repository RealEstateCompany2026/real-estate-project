...
## Task
Create the 'Formulaire création' screen for the Affaires parcours.

## Context
This is screen AFF-03 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Création en 5 étapes (type, bien, clients, détails, mandat).
