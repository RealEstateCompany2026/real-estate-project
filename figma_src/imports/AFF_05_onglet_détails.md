...
## Task
Create the 'Onglet Détails' screen for the Affaires parcours.

## Context
This is screen AFF-05 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Montant, honoraires, dates, mandat. Éditable inline.
