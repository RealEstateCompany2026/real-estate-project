...
## Task
Create the 'Onglet Documents' screen for the Fiche bien parcours.

## Context
This is screen FIB-07 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des documents liés au bien (diagnostics, plans, mandats). Upload drag & drop.
