...
## Task
Create the 'Paramètres app' screen for the Onboarding — Setup parcours.

## Context
This is screen OBS-04 in parcours 4: Onboarding — Setup (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Langue, fuseau, notifications, connexion calendrier.
