...
## Task
Create the 'Signature électronique' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-08 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Envoi en signature : sélection document, signataires, ordre, suivi
