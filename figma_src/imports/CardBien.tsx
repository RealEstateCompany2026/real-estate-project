import svgPaths from "./svg-ull5wtcmk7";
import imgCardBien from "figma:asset/ea149919048c49c233547426cab6a80f99a70e99.png";
import { imgCardBien1 } from "./svg-fbqah";

export default function CardBien() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[22px] items-center pb-[24px] relative rounded-[16px] size-full" data-name="card . bien">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
        <div className="h-[152px] relative rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-full">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-tl-[16px] rounded-tr-[16px] size-full" src={imgCardBien} />
            ...
            <div className="absolute bottom-full left-0 right-0 top-0">
              <div className="absolute inset-[-1px_0_0_0]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 350 1">
                  <line id="Line 18" stroke="var(--stroke-0, #ECEDEE)" x2="350" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
                  ...
                  <div className="content-stretch flex items-center relative shrink-0">
                    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="atome . icon + text . medium">
                      <div className="relative shrink-0 size-[20px]" data-name="icn_database">
                        <div className="absolute inset-[12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3px_-3px] mask-size-[24px_24px]" data-name="database" style={{ maskImage: `url('${imgCardBien1}')` }}>
