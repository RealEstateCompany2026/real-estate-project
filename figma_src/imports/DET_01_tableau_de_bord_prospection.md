...
> Parcours 16: Détection mandat vente / gestion | Vague 3 | Préfixe: DET

## Task
Create the 'Tableau de bord prospection' screen for the Détection mandat vente / gestion parcours.

## Context
This is screen DET-01 in parcours 16: Détection mandat vente / gestion (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vue liste de tous les signaux détectés, filtrable par type/score/zone/statut, avec compteurs synthétiques
