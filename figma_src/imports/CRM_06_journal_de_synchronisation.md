...
## Task
Create the 'Journal de synchronisation' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-06 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Logs détaillés de chaque sync : date, direction, entité, statut, diff
