...
## Task
Create the 'Vue agence (B/C)' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-10 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Pilotage multi-agents : répartition, classement, playbooks agence, budget comparatif
