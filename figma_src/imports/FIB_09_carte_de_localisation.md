...
## Task
Create the 'Carte de localisation' screen for the Fiche bien parcours.

## Context
This is screen FIB-09 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Mini-carte (Leaflet) dans l’onglet Détails. Marker sur l’adresse. Non éditable (dérivée des coordonnées GPS).
