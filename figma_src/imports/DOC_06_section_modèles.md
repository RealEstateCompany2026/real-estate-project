...
## Task
Create the 'Section Modèles' screen for the Documents parcours.

## Context
This is screen DOC-06 in parcours 12: Documents (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des modèles disponibles. Aperçu. Bouton Générer.
