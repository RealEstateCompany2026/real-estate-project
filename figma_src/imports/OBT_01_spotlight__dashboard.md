...
## Task
Create the 'Spotlight : Dashboard' screen for the Onboarding — Product Tour parcours.

## Context
This is screen OBT-01 in parcours 3: Onboarding — Product Tour (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Highlight zone dashboard + tooltip explicatif
