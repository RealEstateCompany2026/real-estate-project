...
## Task
Create the 'Carte thermique base' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-02 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Carte Leaflet avec heatmap des contacts par segment et par zone géographique
