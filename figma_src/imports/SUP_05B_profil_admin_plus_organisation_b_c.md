...
## Task
Create the 'Profil admin + Organisation (B/C)' screen for the Sign-up parcours.

## Context
This is screen SUP-05B in parcours 1: Sign-up (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Profil admin + nom agence, email agence, réseau (si C)
