...
import svgPaths from "./svg-wy5n1lg6h8";
import { imgArrowDropUp, imgAtomeScoringTrend, imgCalendarCheck } from "./svg-rsjiv";
...
export default function ListClient1() {
  return <ListClient className="bg-[#22252b] relative rounded-[16px] size-full" propriete1="hover dark" />;
}