...
## Task
Create the 'Vue kanban' screen for the Affaires parcours.

## Context
This is screen AFF-01 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Pipeline en colonnes drag & drop. Filtres. Toggle kanban/liste.
