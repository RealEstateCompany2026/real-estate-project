...
## Task
Create the 'Onglet Affaires' screen for the Fiche bien parcours.

## Context
This is screen FIB-05 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des affaires liées. Cards avec statut pipeline. Bouton + Nouvelle affaire.
