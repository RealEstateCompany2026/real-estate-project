...
## Task
Create the 'Section Notes & tags' screen for the Ajouter un client parcours.

## Context
This is screen CLI-06 in parcours 6: Ajouter un client (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Champ texte libre (note), Tags (multi-select créables), Source d’acquisition (select : bouche-à-oreille, portail, vitrine, etc.).
