...
## Task
Create the 'Routage persona' screen for the Sign-up parcours.

## Context
This is screen SUP-04 in parcours 1: Sign-up (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: 2 questions (seul/équipe + réseau) + champ conditionnel nom du réseau
