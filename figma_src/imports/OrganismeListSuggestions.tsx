...
export default function OrganismeListSuggestions() {
  return (
    <div className="relative size-full" data-name="organisme. list . suggestions">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center pl-[19px] pr-[18px] py-[48px] relative size-full">
