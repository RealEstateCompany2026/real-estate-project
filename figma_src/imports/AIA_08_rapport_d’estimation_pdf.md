...
## Task
Create the 'Rapport d’estimation PDF' screen for the Automatisations IA parcours.

## Context
This is screen AIA-08 in parcours 15: Automatisations IA (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Document PDF formatifé : bien, comparables, fourchette, disclaimer.
