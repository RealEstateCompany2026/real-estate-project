...
## Task
Create the 'Widget tâches (dashboard)' screen for the Événements parcours.

## Context
This is screen EVT-04 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des tâches triées par échéance. Checkboxes. Tâches en retard highlightées.
