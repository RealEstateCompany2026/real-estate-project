...
## Task
Create the 'Jauge de complétude' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-08 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Barre de progression dans le header. Calculée dynamiquement selon les champs renseignés (pondérés par criticité).
