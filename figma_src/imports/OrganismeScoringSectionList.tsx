import svgPaths from "./svg-1de1pf9h90";
import { imgArrowDropUp, imgArrowDropDown } from "./svg-02skv";
...
export default function OrganismeScoringSectionList1() {
  return <OrganismeScoringSectionList className="relative size-full" />;
}