...
## Task
Create the 'Gestion agence (B/C)' screen for the Connexion CRM & intégrations parcours.

## Context
This is screen CRM-09 in parcours 18: Connexion CRM & intégrations (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Admin : connecteurs agence, permissions, quotas, dashboard global
