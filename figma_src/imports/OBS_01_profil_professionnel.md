...
## Task
Create the 'Profil professionnel' screen for the Onboarding — Setup parcours.

## Context
This is screen OBS-01 in parcours 4: Onboarding — Setup (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Formulaire en sections dépliables : identité, contact, métier, réseau. Jauge de complétion.
