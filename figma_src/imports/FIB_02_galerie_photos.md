...
## Task
Create the 'Galerie photos' screen for the Fiche bien parcours.

## Context
This is screen FIB-02 in parcours 9: Fiche bien (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Carousel pleine largeur. Lightbox fullscreen. Ajout/réordonnancement/suppression en mode édition.
