...
## Task
Create the 'Vue équipe' screen for the Détection mandat vente / gestion parcours.

## Context
This is screen DET-08 in parcours 16: Détection mandat vente / gestion (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Admin B/C : signaux de tous les agents, assignation, stats par collaborateur
