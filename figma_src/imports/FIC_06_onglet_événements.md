...
## Task
Create the 'Onglet Événements' screen for the Fiche client parcours.

## Context
This is screen FIC-06 in parcours 8: Fiche client (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Timeline chronologique. Filtres par type. Chaque entrée : icône + titre + date + détail. Bouton « + Nouvel événement ».
