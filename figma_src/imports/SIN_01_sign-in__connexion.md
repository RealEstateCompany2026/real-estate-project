...
## Task
Create the 'Sign-in : connexion' screen for the Sign-in parcours.

## Context
This is screen SIN-01 in parcours 2: Sign-in (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Google SSO (principal) + formulaire email/password + liens vers sign-up et mot de passe oublié
