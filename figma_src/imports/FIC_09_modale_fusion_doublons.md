...
## Task
Create the 'Modale fusion doublons' screen for the Fiche client parcours.

## Context
This is screen FIC-09 in parcours 8: Fiche client (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Comparaison côte-à-côte de 2 fiches. Sélection champ par champ de la valeur à conserver. Preview du résultat.
