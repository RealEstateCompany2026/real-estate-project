...
## Task
Create the 'Documents réglementaires' screen for the Onboarding — Setup parcours.

## Context
This is screen OBS-03 in parcours 4: Onboarding — Setup (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Zone d’upload par type de document. Statut par document. Alertes d’expiration.
