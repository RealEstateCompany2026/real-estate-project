...
## Task
Create the 'Sélecteur d'audience' screen for the Campagne carnet d'entretien parcours.

## Context
This is screen CAM-03 in parcours 17: Campagne carnet d'entretien (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Filtres propriétaires (ville, type bien, ancienneté) + compteur en temps réel
