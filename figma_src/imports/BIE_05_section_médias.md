...
## Task
Create the 'Section Médias' screen for the Ajouter un bien parcours.

## Context
This is screen BIE-05 in parcours 7: Ajouter un bien (Vague 1). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Upload photos (grid + drag & drop), upload documents (diagnostics, plans).
