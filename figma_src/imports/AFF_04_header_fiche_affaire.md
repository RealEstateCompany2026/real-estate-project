...
## Task
Create the 'Header fiche affaire' screen for the Affaires parcours.

## Context
This is screen AFF-04 in parcours 10: Affaires (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Badge type, stepper pipeline interactif, bien (lien), clients, montant, agent.
