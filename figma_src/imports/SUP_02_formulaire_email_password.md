...
## Task
Create the 'Formulaire email/password' screen for the Sign-up parcours.

## Context
This is screen SUP-02 in parcours 1: Sign-up (Vague 1). This is an authentication screen with no NavRail or AppBar present.
...
**Screen Description**: Email, mot de passe, confirmation. Indicateur de force du mdp.
