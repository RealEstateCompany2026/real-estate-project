...
## Task
Create the 'Centre de notifications' screen for the Événements parcours.

## Context
This is screen EVT-05 in parcours 11: Événements (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Dropdown depuis la cloche header. Liste des notifications. Marquer comme lu.
