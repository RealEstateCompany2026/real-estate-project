...
## Task
Create the 'Catalogue services gratuits' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-08 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Liste des services déployables avec configuration (audience, fréquence, personnalisation)
