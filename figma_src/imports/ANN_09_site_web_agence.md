...
## Task
Create the 'Site web agence' screen for the Annonce immobilière parcours.

## Context
This is screen ANN-09 in parcours 14: Annonce immobilière (Vague 2). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vitrine avec toutes les annonces actives. Template personnalisable (post-MVP).
