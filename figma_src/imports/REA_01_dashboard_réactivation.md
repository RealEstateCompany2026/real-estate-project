...
## Task
Create the 'Dashboard Réactivation' screen for the Réactivation de base dormante parcours.

## Context
This is screen REA-01 in parcours 19: Réactivation de base dormante (Vague 3). NavRail (90px) is present on the left. AppBar should show relevant context for this screen.
...
**Screen Description**: Vue principale : répartition base par segment, courbe évolution, funnel, score santé base, comparatif coûts
