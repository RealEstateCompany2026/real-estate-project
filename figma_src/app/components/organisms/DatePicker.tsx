...
function formatDate(date: Date, format: "short" | "DD/MM/YYYY" | "MM/DD/YYYY" | "YYYY-MM-DD" = "short"): string {
...
export function DatePicker({
  ...
  return (
    <div
      className={`relative rounded-[16px] w-[390px] ${className}`.trim()}
      style={{
        background: "var(--neutral-50)",
    ...
    >
      <div className="p-[24px]">
        ...
        <div
          className="mb-[24px] px-[16px] py-[12px] rounded-[12px] flex items-center justify-between"
          style={{
        ...
        <div className="flex items-center justify-between mb-[16px]">
          <button
            ...
            className="p-[8px] rounded-[8px] transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
            style={{ background: "var(--surface-neutral-action)" }}
            type="button"
        ...
        <div className="flex gap-2 justify-end px-4 pb-4">
          <button
            type="button"
            onClick={onCancel}
            className="px-[10px] py-[8px] hover:opacity-70 transition-opacity cursor-pointer"
          >
            <p
              className="text-[14px] leading-[16px] tracking-[0.14px] font-semibold whitespace-nowrap"
              style={{
                fontFamily: "Roboto, sans-serif",
                color: "var(--text-body)",
              }}
