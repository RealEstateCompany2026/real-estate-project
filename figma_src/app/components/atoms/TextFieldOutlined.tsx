...
export function TextFieldOutlined({
  ...
  return (
    <div
      className={`relative w-full h-[56px] rounded-[8px] border border-solid transition-all duration-200 ${
      ...
      data-name={`textfield-outlined-${error ? "error" : disabled ? "disabled" : isFocused ? "focus" : "default"}`}
    >
      {/* Content */}
