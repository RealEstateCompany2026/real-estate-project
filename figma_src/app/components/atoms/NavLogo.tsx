 ...
 * - Padding: var(--scale-600) vertical (24px), var(--scale-300) horizontal (12px)
 * - Logo: Adaptif light/dark via tokens
 * 
 * Usage:
 * <NavLogo />
 * <NavLogo src="/custom-logo.svg" alt="My Agency" />
 */
    ...
    return (
      <button
        ...
        style={{
          ...
          paddingBottom: "var(--scale-600)",
          paddingLeft: "var(--scale-300)",
          paddingRight: "var(--scale-300)",
        }}
      >
        <svg
