...
export function ListClient({
  ...
  return (
    <div
      className={`group w-full bg-surface-neutral-default hover:bg-surface-neutral-action rounded-lg flex items-center justify-between cursor-pointer transition-colors overflow-hidden ${className}`.trim()}
      onClick={onClick}
    >
