  ...
  return (
    <div className="space-y-2">
      {items.map((item, index) => (
        <div
          key={index}
          className="content-stretch flex flex-col items-start pl-[33px] pr-[37px] relative rounded-[16px] bg-surface-neutral-default border border-edge-default h-[70px]"
        >
