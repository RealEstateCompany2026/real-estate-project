  ...
  return (
    <button
      ...
      className={`
        ...
        font-roboto
        ${isActive ? "font-semibold text-purple-500" : "font-normal text-content-placeholder"}
        ${isHovered && !isActive && !tab.disabled ? "text-neutral-600" : ""}
      `.trim()}
    >
      {/* Icon */}
      ...
      {isActive && (
        <div className="absolute bottom-[-1px] left-0 right-0 h-[2px] bg-purple-500" />
      )}
    </button>
  );
}
