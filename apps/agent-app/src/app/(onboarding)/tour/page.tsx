...
const slides = [
  ...
  },
  {
    ...
    icon: Compass,
    color: 'bg-purple-50 text-[var(--color-indigo-couleur-fonctionnelle)]',
  },
  {
...
export default function OnboardingTourPage() {
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="mt-10 w-full max-w-sm space-y-3">
          {welcomeFeatures.map((f) => (
            <div
              key={f.label}
              className="flex items-center gap-4 p-4 rounded-xl bg-[var(--color-grey-ultra-background)]"
            >
              <f.icon className="w-5 h-5 text-[var(--color-indigo-couleur-fonctionnelle)] flex-shrink-0" />
              <span className="text-sm text-[var(--color-anthracite-textes)]">{f.label}</span>
            </div>
          ))}
        </div>
        ...
        <button
          type="button"
          onClick={() => setStep(0)}
          className="mt-10 w-full max-w-sm py-3 rounded-xl bg-[var(--color-indigo-couleur-fonctionnelle)] text-white font-semibold text-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
        >
          Démarrer le tour
        ...
        <button
          ...
          className="mt-3 text-sm text-[var(--color-grey-bold-textes)] hover:underline"
        >
          Passer le tour
        </button>
      </div>
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <h1 className="mt-8 text-2xl font-bold text-[var(--color-anthracite-textes)]">
        {slide.title}
      </h1>
      <p className="mt-3 text-[var(--color-grey-bold-textes)] max-w-md leading-relaxed">
        {slide.description}
      </p>
      ...
      <button
        type="button"
        onClick={() => router.push('/setup')}
        className="mt-4 text-sm text-[var(--color-grey-bold-textes)] hover:underline"
      >
        Passer le tour
      </button>
    </div>
