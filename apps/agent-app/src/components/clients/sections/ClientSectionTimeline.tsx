...
interface ClientSectionTimelineProps {
  clientId: string;
}
...
/**
 * Section Timeline/Historique de la fiche client (FIC-06).
 * Affiche les 3 derniers événements puis "Voir tout".
 */
export function ClientSectionTimeline({ clientId }: ClientSectionTimelineProps) {
