...
function FormSection({
  ...
  return (
    <div className="border border-edge-default rounded-lg p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-[16px] leading-[20px] font-semibold text-content-headings">{title}</h2>
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-[1191px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-[20px] leading-[24px] font-semibold text-content-headings">
          Ajouter un client
        </h1>
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={handleClose}
            className="p-2 rounded-lg hover:bg-surface-neutral-action transition-colors cursor-pointer"
          >
      ...
      <div className="space-y-6">
        ...
        <FormSection title="Type de client" completion={sectionCompletions[0]}>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-bold text-content-headings mb-1">
                Date de naissance <span className="text-content-error">*</span>
              </label>
              <DatePicker
                variant="docked"
        ...
        <FormSection title="Informations de contact" completion={sectionCompletions[2]}>
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-bold text-content-headings mb-1">
                Adresse <span className="text-content-error">*</span>
              </label>
              <AddressField
        ...
        {/* Section 4 — Marketing */}
        <FormSection title="Marketing (RGPD)" completion={sectionCompletions[3]}>
          <p className="text-xs text-content-caption mb-3">
            Consentement du client pour les communications commerciales.
          </p>
          <div className="space-y-3">
            <Checkbox
              label="Opt-in Email — Le client autorise la réception d'emails commerciaux"
              checked={formValues.emailConsent}
              onChange={(checked) => setValue('emailConsent', checked)}
            />
            <Checkbox
              label="Opt-in SMS — Le client autorise la réception de SMS commerciaux"
              checked={formValues.smsConsent}
              onChange={(checked) => setValue('smsConsent', checked)}
            />
            <Checkbox
              label="Opt-in WhatsApp — Le client autorise les messages WhatsApp"
